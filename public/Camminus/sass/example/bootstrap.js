...
Ext.ClassManager.addNameAlternateMappings({
  "Camminus.Application": [],
  "Camminus.controller.Cases": [],
  "Camminus.controller.Companies": [],
  "Camminus.controller.Costumers": [],
  "Camminus.controller.Main": [],
  "Camminus.controller.Menu": [],
  "Camminus.controller.Roles": [],
  "Camminus.controller.Services": [],
  "Camminus.controller.TranslationManager": [],
  "Camminus.controller.Users": [],
  "Camminus.model.Case": [],
  "Camminus.model.Company": [],
  "Camminus.model.ContractType": [],
  "Camminus.model.Costumer": [],
  "Camminus.model.Role": [],
  "Camminus.model.Service": [],
  "Camminus.model.User": [],
  "Camminus.model.menu.Item": [],
  "Camminus.model.menu.Root": [],
  "Camminus.store.Cases": [],
  "Camminus.store.Companies": [],
  "Camminus.store.Costumers": [],
  "Camminus.store.CostumersSearch": [],
  "Camminus.store.Menu": [],
  "Camminus.store.Roles": [],
  "Camminus.store.Services": [],
  "Camminus.store.Users": [],
  "Camminus.store.cases.Previsao": [],
  "Camminus.store.cases.Prioridade": [],
  "Camminus.store.cases.Services": [],
  "Camminus.store.cases.Status": [],
  "Camminus.store.cases.Tipo": [],
  "Camminus.store.cases.TipoEquip": [],
  "Camminus.util.Alert": [],
  "Camminus.util.MD5": [],
  "Camminus.util.SessionMonitor": [],
  "Camminus.util.Util": [],
  ...
  "Camminus.view.MainView": [],
  "Camminus.view.Translation": [],
  "Camminus.view.Viewport": [],
  "Camminus.view.cases.Form": [],
  "Camminus.view.cases.Grid": [],
  "Camminus.view.cases.lab.Opened": [],
  "Camminus.view.companies.Form": [],
  "Camminus.view.companies.Grid": [],
  "Camminus.view.costumers.Form": [],
  "Camminus.view.costumers.Grid": [],
  "Camminus.view.menu.Accordion": [],
  "Camminus.view.menu.Item": [],
  "Camminus.view.roles.Grid": [],
  "Camminus.view.services.Form": [],
  "Camminus.view.services.Grid": [],
  "Camminus.view.users.Form": [],
  "Camminus.view.users.Grid": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Camminus.view.cases.lab.Opened": [
    "widget.caseslabopened"
  ],
  "Camminus.view.companies.Form": [
    "widget.companiesform"
  ],
  "Camminus.view.companies.Grid": [
    "widget.companiesgrid"
  ],
  "Camminus.view.costumers.Form": [
    "widget.costumersform"
  ],
  "Camminus.view.costumers.Grid": [
    "widget.costumersgrid"
  ],
  "Camminus.view.menu.Accordion": [
    "widget.mainmenu"
  ],
...
Ext.setVersion("ext-theme-neptune-2392eeb3-8084-4665-9dcf-6101114c7f51", "1.0.0");
