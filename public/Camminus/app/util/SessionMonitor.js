 ...
 * logged out.
 */
Ext.define('Camminus.util.SessionMonitor', {
  singleton: true,
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    buttons: [{
      ...
      handler: function() {
        Ext.TaskManager.stop(Camminus.util.SessionMonitor.countDownTask);
        Camminus.util.SessionMonitor.window.hide();
        Camminus.util.SessionMonitor.start();
